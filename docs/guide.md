...
2. On the **Start Here** tab, click the **Set this copy up** button — or use the **Actions** menu → **⚠ Set up this copy**, which does the same thing. Google asks permission once, and asks narrowly: to work with **this spreadsheet only**, and to run when you're not watching — that second one is what makes repeating entries appear on their own. It cannot see anything else in your Drive. If a screen tells you the app isn't verified, that's Google's standard wording for any sheet carrying its own code; **Advanced → Continue** goes through it. Skipping this step is the one way to break Hisaab — the sheet looks perfect and quietly does nothing. You'll know it worked when that menu item reads **Re-run setup**.
...
3. Three settings, one tab: your **income goal**, your **months to survive** (how long you could run with nothing coming in — 6 is the least worth aiming at), and the month your **financial year** starts. That's all you're asked for; everything else the sheet works out from your own rows. Change them any time.
...
Why both? They answer different questions. From → To says *who to whom*. The sign says *did my money grow or shrink* — without you ever teaching the sheet which names are "you". Ravi hands you ₹5,000: `ravi → cash, +5,000`. You return it next week: `cash → ravi, −5,000`. Same two names, opposite signs, everything clear.
...
The **Monthly Snapshot** shows last month, this month, and the next twelve: in, out, net, balance, and a small bar per month. The bar's colour deepens as a month sinks toward your safety money — so your scariest month is visible long before it arrives, while there's still time to do something about it.
...
| **Usable for Growth** | unused money — what's left after your safety money is safe |
| **Used to Grow** | money put to work — how much of your spending *built* something |

Three of these deserve a second look:

**Breakeven** counts your committed payments plus your own average of everyday spending — and it never counts money you're merely expecting. A cheque in the post pays no bills. It also teaches the honest shape of money: the next 30 days never stop coming. The question is never *am I done?* — it's *can I keep running?* That's not bleak; that's just the game, seen clearly. Months of cover — how long you could run with nothing coming in — is the calmest number in money.
...
**And when a big payment lands**, the sheet translates it into the only unit that matters: *"₹5.2 L landed in the last month — that's 3.4 months of running costs covered."* A lump becomes runway. This is the whole bind of project work in one sentence — costs arrive monthly, income arrives in lumps — and the line stays silent unless something notable actually turns up, which is what makes it feel like the sheet noticed rather than the sheet talking.
...
For a job, one column earns a second look: **Money life** — *Jun 26 → Aug 26 · 3 mths · 5 in · 9 out*. When the money started, when it stopped, how long it ran, and how many payments went each way. Five milestones and nine supplier bills is a very different job from one and one.

It is deliberately *money* life, not project life. The sheet doesn't know when your project started — it knows when money moved, and those are not the same thing. That difference is exactly the point: a two-month job can be a five-month cash story. Advance in June, costs through July, the balance in October. Nothing else shows you that gap, and in project work the gap is what actually hurts. Leave the period blank and you see the whole life; set one and you see that window.
